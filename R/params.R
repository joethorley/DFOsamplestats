...
#' @param alpha1 A numeric vector of the first shape parameter for the beta distribution for the first group.
#' @param beta1 A numeric vector of the second shape parameter for the beta distribution for the first group.
#' @param alpha2 A numeric vector of the first shape parameter for the beta distribution for the second group.
#' @param beta2 A numeric vector of the second shape parameter for the beta distribution for the second group.
...
#' @param niter The number of iterations per chain for MCMC sampling.
