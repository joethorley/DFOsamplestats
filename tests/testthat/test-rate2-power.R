test_that("rate2_power works", {
  ...
  expect_equal(rate2_power(0.005, p2 = 0.0075, 15599 * 2, alternative = "less"), 0.876326816946488)
  expect_equal(rate2_power(0.005, p2 = 0.0075, 15599 * 2, alternative = "greater"), 0)
  expect_equal(rate2_power(0.005, p2 = 0.0075, 12287 * 2, alternative = "less"), 0.800006059196688)
})
