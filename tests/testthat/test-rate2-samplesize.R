...
test_that("rate2_samplesize works", {
  ...
  expect_identical(rate2_samplesize(0, 1, alternative = "greater"), 3L)
  expect_identical(rate2_samplesize(0.9, 0.1), 10L)
  expect_identical(rate2_samplesize(0.9, 0.1, alternative = "greater"), Inf)
  expect_identical(rate2_samplesize(0.9, 0.1, alternative = "less"), 8L)
  expect_identical(rate2_samplesize(0.1, 0.9, alternative = "greater"), 8L)
  expect_identical(rate2_samplesize(0.01, 0.09, alternative = "greater"), 182L)
  expect_identical(rate2_samplesize(0.45, 0.55, alternative = "greater"), 617L)
  expect_identical(rate2_samplesize(0.005, 0.0075), 31197L)
  expect_identical(rate2_samplesize(0.005, 0.0075, alternative = "greater"), 24574L)
})
